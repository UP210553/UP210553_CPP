    ...
    do
    {
        ...
        if (mododejuego == 1)
        {
            do
            {
                ...
                cout << endl;
                cout << endl;
               cout<<"\033[1;31m"<<"ＰＬＡＹＥＲ  ＢＯＡＲＤ"<<"\033[0m"<<endl;
                CrearTablero();
                elegirbarcos();
            ...
            cout << endl;
            cout << endl;
            cout<<"\033[1;34m"<<"ＰＣ ＢＯＡＲＤ"<<"\033[0m"<<endl;
            cout << endl;
            CrearTablero();
    ...
    for (int row = 0; row < 23; row++)
    {
        for (int col = 0; col < 23; col++)
        {
            ...
            else
            {
                ...
                {
                    cout <<"\033[1;33m"<< " 1 "<< "\033[0m";
                }
                else if (row == 1 && col == 5)
                {
                    cout <<"\033[1;33m"<< " 2 "<< "\033[0m";
                }
                else if (row == 1 && col == 7)
                {
                ...
                {
                    cout << "\033[1;33m"<<" 4 "<< "\033[0m";
                }
                else if (row == 1 && col == 11)
                {
                    cout << "\033[1;33m"<<" 5 "<< "\033[0m";
                }
                else if (row == 1 && col == 13)
                {
                    cout << "\033[1;33m"<<" 6 "<< "\033[0m";
                }
                else if (row == 1 && col == 15)
                {
                    cout <<"\033[1;33m"<< " 7 "<< "\033[0m";
                }
                else if (row == 1 && col == 17)
                {
                    cout << "\033[1;33m"<<" 8 "<< "\033[0m";
                }
                else if (row == 1 && col == 19)
                {
                    cout << "\033[1;33m"<<" 9 "<< "\033[0m";
                }
                else if (row == 1 && col == 21)
                {
                    cout <<"\033[1;33m"<< " 10"<< "\033[0m";
                }
                else if (row == 3 && col == 1)
                {
                ...
                {
                    cout << "\033[1;33m"<<" F "<< "\033[0m";
                }
                else if (row == 15 && col == 1)
                {
                    cout <<"\033[1;33m"<< " G "<< "\033[0m";
                }
...
void preguntardondeatacar()
{
    ...
    if (turnodejugador == 1)
    {
        ...
        {
            gotoxy(50, 15);
            cout<<"\033[1;31m"<<"𝙿𝙻𝙰𝚈𝙴𝚁 𝚃𝚄𝚁𝙽 "<<"\033[0m"<<endl;
        }
        else
        {
            gotoxy(50, 15);
           cout<<"\033[1;34m"<<"𝙿𝙻𝙰𝚈𝙴𝚁 𝚃𝚄𝚁𝙽 𝟷"<<"\033[0m"<<endl;
        }
    }
    else
    {
        ...
        {
            gotoxy(50, 15);
            cout<<"\033[1;31m"<<"𝙿𝙻𝙰𝚈𝙴𝚁 𝚃𝚄𝚁𝙽 𝟤"<<"\033[0m";
        }
    }
