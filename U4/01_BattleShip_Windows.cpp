            ...
            else
            {
                ...
                else
                {
                    if (numerodetablero == 3)
                    {
                        ...
                        else if (matriz[x][y] == 2 || matriz[x][y] == 3 || matriz[x][y] == 4 || matriz[x][y] == 5 || matriz[x][y] == 9)
                        {
                            cout << "\033[1;34m"
                                 << " o "
                                 << "\033[0m";
                    ...
                    else
                    {
                        ...
                        {
                            if (matrizJ1[x][y] == 0 || matrizJ1[x][y] == 2 || matrizJ1[x][y] == 3 || matrizJ1[x][y] == 4 || matrizJ1[x][y] == 5 || matrizJ1[x][y] == 9)
                            {
                                cout << "\033[1;34m"
                                     << " x "
                                     << "\033[0m";
                            }
                            else if (matrizJ1[x][y] == 6)
                            {
                                cout << "\033[1;32m"
                                     << " x "
                                     << "\033[0m";
                        ...
                        {
                            if (matrizJ2[x][y] == 0 || matrizJ2[x][y] == 2 || matrizJ2[x][y] == 3 || matrizJ2[x][y] == 4 || matrizJ2[x][y] == 5 || matrizJ2[x][y] == 9)
                            {
                                cout << "\033[1;34m"
                                     << " x "
                                     << "\033[0m";
                            }
                            else if (matrizJ2[x][y] == 6)
                            {
                                cout << "\033[1;32m"
                                     << " x "
                                     << "\033[0m";
...
void elegirbarcos()
{
    cout << "\033[1;31m"
         << "𝘗𝘓𝘈𝘊𝘌 𝘠𝘖𝘜𝘙 𝘚𝘏𝘐𝘗𝘚"
         << "\033[0m" << endl;
    cout << barcos2 << "\033[0;37m"
         << "  𝑩𝑶𝑨𝑻 𝑺𝑰𝒁𝑬 𝑻𝑾𝑶"
         << "\033[0m" << endl;
    cout << barcos3 << "\033[0;37m"
         << "  𝑩𝑶𝑨𝑻 𝑶𝑭 𝑺𝑰𝒁𝑬 𝑻𝑯𝑹𝑬𝑬"
         << "\033[0m" << endl;
    cout << barcos4 << "\033[0;37m"
         << "  𝑩𝑶𝑨𝑻 𝑶𝑭 𝑺𝑰𝒁𝑬 𝑭𝑶𝑼𝑹"
         << "\033[0m" << endl;
    cout << barcos5 << "\033[0;37m"
         << "  𝑩𝑶𝑨𝑻 𝑶𝑭 𝑺𝑰𝒁𝑬 𝑭𝑰𝑽𝑬"
         << "\033[0m" << endl;
